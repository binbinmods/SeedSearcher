...
def dicts_to_excel(dict_sheet_pairs, output_file):
    ...
    with pd.ExcelWriter(output_file) as writer:
        for dictionary, sheet_name in dict_sheet_pairs:
            ...
            if sheet_name != "Caravan Items":
                # print("hello")
                # df[['Boss Loot ID', 'Item Name']] = df['Item'].str.split(' - ', expand=True)
                # df.drop('Item', axis=1, inplace=True)
                
                result = df["Item"].str.split(' - ',expand=True)
                
                result = result.loc[:,[0,1]]
                df.insert(0,"Item Name", result[1])
                df.insert(0,"Loot ID", result[0])
                df.drop('Item', axis=1, inplace=True)
                # df.rename(columns={0:'Loot ID', 1:'Item Name'}, inplace=True)
...
def set_dicts():
    ...
    if not bossDict:
        bossDict = {"Basthet - Durandal":["QG9SSM8","ME29XME","YWDPPPW","NSWPRD8","EDG2SFS"],"Basthet - Holy Rune":["QG9SSM8","QFT2A53","YWDPPPW","8SMBHN6","2MG5MWE"],"Basthet - Tesseract":["4A94PSN","B94WECY","ME29XME","GTFFWW5","BGERKXW"],"Basthet - The Juggernaut":["XF5828Z","XB8RZ2C","MKS82P9","F4BZQBK","Y5SZQES"],"belphyor - Belphyor's Pipe":["54RRTRE","46458YM","FZZ5SF4","S5PCR3M","TEZ8X5E"],"belphyor - Searing Dagger":["ZSXYDN4","NKMWMEF","T6EAFNT","FMH8D2D","R6SBKK6"],"belphyorquest - Flamy":["FF2RQWH","QXZBY6T","N3AE6KY","6YTYGH4","Y6R94BZ"],"belphyorquest - Searing Dagger":["BBM4RYK","8CQFRK4","4SZWBEW","N3AE6KY","BRSTG3P"],"burninghand - Hellblade":["99ABQKS","P6XWX5K","6R9H258","ZZNYS6N","XPA3DDW"],"burninghand - Imp Statuette":["ARH3K4T","YTXK2HS","YECCC4C","9WS4D4X","ZZNYS6N"],"burninghand - Ring of Fire":["WM9FYTP","RBSDX4R","K9RK5BZ","AKAYG3N","HA3DDP8"],"dreadhalfman - Rudder":["P2T2AR6","WNHCFWM","E8Y2RFQ","48ET4QS","KPFQ5NM"],"dreadhalfman - Sextant":["6KHPZ2P","CC9RANZ","48ET4QS","WAH3BDP","MNHWZ6M"],"dreadhalfman - Tiny Cannon":["T8K9CX6","M263TN2","6KHPZ2P","E8Y2RFQ","48ET4QS"],"Dryad_a - Dryad Mask":["SAAF6Q2","CRADCCA","6RNG88B","93ZN4B5","C8GZP4E"],"Dryad_a - Forest Crown":["54DMBQ2","SNWNH8Y","M5QDMSS","HSRCG4Q","N5P3KSF"],"Dryad_b - Forest Crown":["TE2X98X","BMK4FWR","A5CX242","H5S9PZ2","EG4DQPA"],"elvenarmory - Ice Orb":["TF948W5","ZMYRQPT","WW36S23","4EX9HB4","QKX6B32"],"elvenarmory - Icebreaker":["PX3PF3X","DZ6D6FK","AE4C8QX","WBGSZPB","5TY5MDE"],"elvenarmoryplus - Ice Orb":["D6WDK94","NPRNBFC","KT4KSSA","QE3KS3H","8ZZ3D2N"],"elvenarmoryplus - Icebreaker":["2SATRYH","DKQN3PE","RYSE6QS","NYK5Y2S","CZSFXTY"],"elvenarmoryplus - Paladin Gauntlets":["CD6WM53","9H6M4CQ","QSYCEN3","MXQ959Q","QA35DE4"],"Faeborg - Faeborg Scale":["CGB3BPW","S8QN9YW","8953HDN","QAM62YM","XQN4E2S"],"Faeborg - Freezing Ink":["FKH8ZQB","HT5YGP9","P3TA5Q9","6NQFTM9","5XTW65Q"],"Faeborg - Frozen Tear":["SMRQGK6","9Q843PM","6KAS5S6","PM6QBPX","RNXZXGQ"],"goblintown - Goblin Amulet":["6X38Y6P","RMRSA44","F3YW4TF","NENSWYQ","FX9PAHK"],"goblintown - Iron Kanabo":["Z4CMPM3","QKT64C5","Z38A6NY","HWQ6XTB","NQBF6PM"],"goblintown - Raider Slicer":["X9S5FFZ","PSAQF9Z","ZA9H3R5","8ABG6KC","DQS9BER"],"harpychest - Stormcaller Feather":["QDGNWA5","4SAENWM","3Z52GBH","PWBHXX5","NC9KXSX"],"harpychest - Tempest":["KCDFNDY","FY8BWST","YGGYHF8","RDH4CQR","Z8B2QQW"],"harpyfight - Matriarch's Claw":["NFZHSCA","9GAE2CM","BPCE8Z5","GDPNHPE","MXSWKAB"],"harpyfight - Stormcaller Feather":["ZGWQSQQ","AQSWGQS","3WN6B9R","4M9DBED","59F4B5Q"],"Hydra - Hydra Egg":["2529QEX","2BY286K","8N3BWKN","TTN4BM8","N6Q6F6N"],"Hydra - Storm Tiara":["43YYFAC","BD9QK3H","QA4DRF3","YERMWPY","FZ9EHQ6"],"Hydra - The Polluter":["B3WR98F","AFESATQ","N6Q6F6N","8HDY4KC","F4TG9WX"],"Hydra - Titan Gauntlets":["6EQKT2W","2BY286K","B3WR98F","S9QZ6EY","AFESATQ"],"Ignidoh - Ignidoh's Core":["MR9MP8B","TNX5MNR","9G335ZK","SA5XXNA","WQQA892"],"Ignidoh - Lava Crystal":["H3TG33Q","EY3C4RY","C596RFA","S3WSTAR","KNRDRP3"],"Ignidoh - Volcanic Axe":["PAW6PER","X86YN8F","NBS5633","3EX6ZHS","2B5HQB8"],"khazakdhum - Bronze Gear":["PSZXTGG","SET9QCS","KBPMGBM","N9DMBKS","3R6A4DW"],"khazakdhum - Lava Orb":["KBPMGBM","MBFHAK2","AZMYMZG","6XG2CP5","Q6W53YT"],"khazakdhum - Lava Potion":["TG3KZTH","5QHKGHQ","Q4EWEEC","2XARNZP","APFETTX"],"khazakdhum - The Wall":["ZT2CDF3","RATCBZD","AAC3342","C262TMG","S2SS3AM"],"kingrat - Black Deck":["8WRC9Q3","63236GM","9GCTTFC","4DP2WFS","4FPNCRG"],"kingrat - Frozen Heirloom":["4EEFPFC","9GCTTFC","4DP2WFS","82YQYKR","ZDX4Q6R"],"kingrat - Ice Orb":["GWYAMBA","38AAH3W","E3PBPGM","4DP2WFS","FPB8XX3"],"kingrat - Neverfrost":["8WRC9Q3","YTQFGYZ","EMN4DQ4","Y533EKH","ECQTAAF"],"Mansionright - Cold Rune":["PYRCGY3","F69MNFT","ATPMQBA","ZHHE36B","G9DR3ZY"],"Mansionright - Dracomancer Staff":["GRAMXHM","B5EEB9E","W8BHE3Z","N6D6S3T","PYM6NAC"],"minotaurcave - Edge of Fury":["CSFWSXD","PQ5BYWS","YM9FCBB","YXTBZKM","ZXAGQ4F"],"minotaurcave - Minotaur Horn":["9KH9TDN","ZB5KB8E","E3Z5BF2","N3FWKC5","SXSBFFF"],"minotaurcave - Red Cape":["6KBFKSX","9WRWQPR","N32KBZ5","Y9NM2WZ","N3FWKC5"],"Mortis - Architect's Ring":["RCYFWHQ","CRDC8XC","PN9236H","Z3HE29C","3P4HN4X"],"Mortis - Burial Mask":["KW4M9CF","2D8DYC4","EKXXB6W","WRRPEC5","WC45CTT"],"Mortis - Scarab Shield":["CRDC8XC","Z8GWAF5","Z3HE29C","6EWE86B","PXRRSS8"],"Mortis - Undeath Ichor":["YNBPD9A","Z3HE29C","QKEPSC9","YXKKRAB","6BCN8KD"],"sahtikraken - Kraken Sushi":["QFFYSNR","HESCBG5","GYQWYAB","TCN4GEB","EDADRDS"],"sahtikraken - Purple Tentacle":["6B54N3A","W9PT9BH","9B3G9AR","ZR8Y4ZT","HESCBG5"],"sahtikraken - Storm In A Bottle":["EDADRDS","XTP44C3","3DKF49R","YYB9RMC","SPGQKT3"],"sahtikrakenmjolmir - Kraken Sushi":["PFFBK2B","95WAH2E","33622DH","ZZQSZF5","T8PGS5W"],"sahtikrakenmjolmir - Mjolnir":["BS36QGR","PRN428N","SH3G9FS","BR2YR5H","SAASPBK"],"sahtikrakenmjolmir - Purple Tentacle":["QXYWDN9","QCWKAFB","BASHRGG","R5RFMTS","DSY4H59"],"sahtikrakenmjolmir - Storm In A Bottle":["E8PFHW6","QGNH239","3ZHQ484","8H5ATYT","5GS9P5P"],"sahtirustkingtreasure - Jolly Roger":["4C8E3SZ","28BT892","WYRT84T","6Q4CM24","TDRG348"],"sahtirustkingtreasure - Pirate Hat":["NWASHY4","GHKMQTB","W4FHG5G","QYYBCG2","H5E6E42"],"sahtirustkingtreasure - Rusty Hook":["GMAR2KQ","DXQH9AB","SMG95MY","8XCPZCD","WNX8BCW"],"spiderqueen - Free Lover":["G96WFQT","Q46RYGE","32GNDSZ","PG5RMRG","NZXGKXQ"],"spiderqueen - Spider Queen Eye":["B6ZE96B","ABN34WA","85YNBT5","DRQRXR3","SGDTETD"],"spiderqueen - Venom Fang":["88XFPG8","RE8TAZ5","5AQ6K9P","Y6M3PKE","HRCDF2H"],"Tulah - Free Lover":["DRFTZDT","G6KXNFS","FHSAP69","SCY2WZZ","NG6XZGH"],"Tulah - Spider Queen Eye":["NCH3DPK","54CKP9A","TQXHWZ5","3ZKWEGR","HTTRSYM"],"Tulah - Venom Fang":["YNCWRGB","8NX6AZM","G8B8XAN","SPESK85","6AEWBC9"],"tyrant - Frost Axe":["Y3M998P","ZMQBB94","6T4XYQR","Z34ADBS","Q9NERWE"],"tyrant - Tyrant Necklace":["6W3GR8C","XMY86HX","BBCZTY2","AETRFYH","Y569N5D"],"tyrantbeavers - Champy":["RFCYPMX","W5K2TK8","Y3K6CC5","WWKHQGC","NGCHZYW"],"tyrantbeavers - Chompy":["N5E3FBH","WWKHQGC","Q9G6WGT","NQSQZF2","E4KFPPH"],"tyrantbeavers - Chumpy":["T45P25F","36HZ85M","8FNDNSE","CSX4ZK5","6TE3BRN"],"tyrantbeavers - Frost Axe":["YN5P28K","3EDCZMT","DTHG9DB","9DMKE6Z","DZTQCH5"],"tyrantbeavers - Tyrant Necklace":["Q9XBCB8","SM22T5N","9DMKE6Z","E4KFPPH","YTF45MS"],"tyrantchampy - Champy":["QRPNRHH","GZFTRAZ","M6TDF92","XT2GW8Z","N8GFAYN"],"tyrantchampy - Frost Axe":["QDAEMY3","SHT3GEQ","WWECSP4","CDANEDH","XWGDXNS"],"tyrantchampy - Tyrant Necklace":["ZW2NKPD","2S3C3XQ","853FCNN","EWARSZK","RHK4PZ3"],"tyrantchompy - Chompy":["3R26Y6Q","95Z4YZ9","CH9C22D","B596GCF","3Y53YHN"],"tyrantchompy - Frost Axe":["5Z3SYNP","MG9FMYX","CC8WGPS","DMBDMEY","23HNBXF"],"tyrantchompy - Tyrant Necklace":["RWNHBF8","NBQQRNS","X9ZNWXQ","HGDF6BF","23HNBXF"],"tyrantchumpy - Chumpy":["QMZB54W","2Q3SEWW","HXD6S43","M3HG2FS","645XZQ9"],"tyrantchumpy - Frost Axe":["QMAHA2H","ZABG82Q","WKZ5EZ9","WHABDER","SNY4BG5"],"tyrantchumpy - Tyrant Necklace":["58YDQ8N","PKZHQFZ","H9XMXQA","5Z598HQ","PGNXNBN"],"upripreboss - Blunderbuss":["HPW2TWA","SFNTBRK","P2B9TBD","8PKB5KQ","8WDD8HP"],"upripreboss - Dwarven Helmet":["GAS6PGF","EXCHZMF","CATZPQT","SFNTBRK","4NPA8KE"],"upripreboss - Machine Oil":["CMEE8C9","HPW2TWA","P2B9TBD","QS25RDX","95ZPR59"],"Ylmer - Shield of Thorns":["EX53KGF","D5928YY","9KFNCBF","2GHKA9P","CDB83XN"],"Ylmer - Yggdrasil Root":["XY93G83","HWE4ZXH","DSD326X","923DTF3","FPD8N2M"],"Ylmer - Ylmer's Branch":["DEP4H93","5KDB3RD","2ZTZ8TW","MZBXRPW","5TZEZK2"],"yogger - Brigand Armor":["EABCD24","MHB2A8F","CS23MXQ","PW66ZZW","5WWDCWS"],"yogger - Wolfskin Cloak":["882FFTR","FB9WRX5","S8RF2NR","4553FCE","2DRCFK9"],"yogger - Yogger's Cleaver":["52QRW35","CHR2HT3","HZGR6W3","E6ZXRQ2","4BW659H"]}
...
if __name__ == "__main__":
    ...
    dict_sheet_pairs = [
        ...
        # (shopDict, 'Shop Items'),
        # (guaranteedDict, 'Non-Boss Drops'),
        # (petDict, 'Pet Drops'),
        (bossDict, 'Corrupted Boss Drops'),
        # (mythicDict, 'Mythics')
    ]
